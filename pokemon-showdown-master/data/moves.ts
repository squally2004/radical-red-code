...
Non-Contact: Is a special attack.
...
export const Moves: { [moveid: string]: MoveData } = {
	...
	absorb: {
		...
		pp: 25,
		priority: 0,
		flags: { protect: 1, mirror: 1, heal: 1, special: 1 },
		drain: [1, 2],
		secondary: null,
		target: "normal",
		type: "Grass",
	...
	aeroblast: {
		...
		pp: 5,
		priority: 0,
		flags: { protect: 1, mirror: 1, distance: 1, special: 1 },
		critRatio: 2,
		secondary: null,
		target: "any",
		type: "Flying",
	...
	aurasphere: {
		...
		pp: 20,
		priority: 0,
		flags: { bullet: 1, protect: 1, pulse: 1, mirror: 1, distance: 1, special: 1 },
		secondary: null,
		target: "any",
		type: "Fighting",
		contestType: "Beautiful",
	...
	bouncybubble: {
		...
		pp: 20,
		priority: 0,
		flags: { protect: 1, heal: 1, special: 1 },
		drain: [1, 2],
		secondary: null,
		target: "normal",
		type: "Water",
	...
	burnup: {
		...
		pp: 5,
		priority: 0,
		flags: { protect: 1, mirror: 1, defrost: 1, special: 1 },
	...
	charge: {
		...
		condition: {
			duration: 99999999999999999999999999999999999999999999999,
			onRestart(pokemon) {
	...
	chatter: {
		...
		pp: 20,
		priority: 0,
		flags: { protect: 1, mirror: 1, sound: 1, distance: 1, bypasssub: 1, special: 1 },
		noSketch: true,
		secondary: {
			chance: 100,
	...
	clangoroussoulblaze: {
		...
		pp: 1,
		priority: 0,
		flags: { sound: 1, bypasssub: 1, special: 1 },
		selfBoost: {
			boosts: {
				atk: 1,
				def: 1,
	...
	darkpulse: {
		...
		pp: 15,
		priority: 0,
		flags: { protect: 1, pulse: 1, mirror: 1, distance: 1, special: 1 },
		secondary: {
			chance: 20,
			volatileStatus: 'flinch',
		},
	...
	earthpower: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, nonsky: 1, special: 1 },
		secondary: {
			chance: 10,
			boosts: {
				spd: -1,
	...
	fierydance: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, dance: 1, special: 1 },
		secondary: {
			chance: 50,
			self: {
				boosts: {
	...
	frenzyplant: {
		...
		pp: 5,
		priority: 0,
		flags: { recharge: 1, protect: 1, mirror: 1, nonsky: 1, special: 1 },
		self: {
			volatileStatus: 'mustrecharge',
		},
		secondary: null,
	...
	grassknot: {
		...
		pp: 20,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, nonsky: 1, special: 1 },
		onTryHit(target, source, move) {
	...
	hyperspacehole: {
		...
		pp: 5,
		priority: 0,
		flags: { mirror: 1, bypasssub: 1, special: 1 },
		breaksProtect: true,
		secondary: null,
		target: "normal",
		type: "Psychic",
	...
	infestation: {
		...
		pp: 20,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, special: 1 },
		volatileStatus: 'partiallytrapped',
		secondary: null,
		target: "normal",
		type: "Bug",
	...
	oblivionwing: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, distance: 1, heal: 1, special: 1 },
		drain: [3, 4],
		secondary: null,
		target: "any",
		type: "Flying",
	...
	originpulse: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, pulse: 1, mirror: 1, special: 1 },
		target: "allAdjacentFoes",
		type: "Water",
		contestType: "Beautiful",
	},
	...
	petaldance: {
		...
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, dance: 1, special: 1 },
		self: {
			volatileStatus: 'lockedmove',
		},
		onAfterMove(pokemon) {
	...
	pollenpuff: {
		...
		pp: 15,
		priority: 0,
		flags: { bullet: 1, protect: 1, mirror: 1, allyanim: 1, special: 1 },
		onTryHit(target, source, move) {
	...
	seedflare: {
		...
		pp: 5,
		priority: 0,
		flags: { protect: 1, mirror: 1, special: 1, ballistic: 1 },
		secondary: {
			chance: 40,
			boosts: {
				spd: -2,
	...
	worryseed: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, reflectable: 1, mirror: 1, allyanim: 1, special: 1 },
		onTryImmunity(target) {
